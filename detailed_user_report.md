...
| TC-09 | POST /accounts/login/ - неверный логин/пароль              | Ошибка аутентификации           | Ошибка отображена       | PASS     |
...
| ✅ Invalid Login          | POST    | /accounts/login/           |      200 | 200             | Form error displayed          |
